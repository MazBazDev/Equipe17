            ...
            <tbody>
                @foreach ($data as $item)
                    <tr class="border-b text-gray-100">
                        <td class="text-sm text-gray-100 font-light px-6 py-4 whitespace-nowrap">{{ $item->id }}</td>
                        <td class="text-sm text-gray-100 font-light px-6 py-4 whitespace-nowrap">{{ $item->side }}</td>
                        <td class="text-sm text-gray-100 font-light px-6 py-4 whitespace-nowrap">{{ $item->scoreR }}</td>
                        <td class="text-sm text-gray-100 font-light px-6 py-4 whitespace-nowrap">{{ $item->scoreB }}</td>
                        <td class="text-sm text-gray-100 font-light px-6 py-4 whitespace-nowrap">{{ $item->gamemode }}</td>
